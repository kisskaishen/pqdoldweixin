...
new Vue({
	...
	mounted: function(){
		...
		$.ajax({
			type:'POST',
			url:'https://testapi.pinquduo.cn/api_3_0_1/goods/getCountries?version=2.0.0&page='+self_.page+'&pagesize='+self_.pagesize+'&id='+pavilion_id+'&ajax_get=1',//获取数据
			dataType:'jsonp',
			jsonp: 'jsoncallback',
			async:false,
			success:function(data){
		        ...
		        self_.pavilion_data = data.result.countries;
