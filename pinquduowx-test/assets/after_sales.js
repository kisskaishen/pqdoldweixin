...
new Vue({
	...
	methods: {
		...
		get_order: function(){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://testapi.pinquduo.cn/api_3_0_1/user/return_goods_list'+'?version=2.0.0&user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		up_load: function(){
			...
			pullup_load({
				...
				callback: function(){
					...
					$.ajax({
						type:'POST',
						url:'https://testapi.pinquduo.cn/api_3_0_1/api/user/return_goods_list'+'?user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&ajax_get=1',//获取数据
						dataType:'jsonp',
						jsonp: 'jsoncallback',
						async:true,
						success:function(data){
