...
new Vue({
    ...
    methods: {
        ...
        get_header_data: function() {
            ...
            $.ajax({
                type: 'GET',
                url: 'https://testapi.pinquduo.cn/api_3_0_1/index/getexplore?ajax_get=1&version=2.0.0', //获取首页数据
                dataType: 'jsonp',
                jsonp: 'jsoncallback',
                async: true,
                success: function(data) {
        ...
        //         $.ajax({
        //             type: 'GET',
        //             url: 'https://testapi.pinquduo.cn/api_3_0_1/user/getPromDetail?invitation_num=' + prom_code + '&user_id=' + cookie.get('user_id') + '&ajax_get=1',
        //             dataType: 'jsonp',
        //             jsonp: 'jsoncallback',
        //             async: true,
        //             success: function(data) {
