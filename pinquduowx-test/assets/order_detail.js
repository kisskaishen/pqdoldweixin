		...
		new Vue({
			...
			methods: {
				...
				pay_order: function(){
                    ...
                    //     //免单拼开团
                    //     var payScriptUrl='https://testapi.pinquduo.cn/api_3_0_1/Purchase/getBuy'+location.search.replace('&num='+buy_count,'&num='+self_.buy_count)+'&address_id='+address_id+'&prom='+self_.prom_count+'&free='+self_.free_count+'&openid='+openid+'&code='+self_.pay_oauth+'&ajax_get=1&version=2.0.0';
                    // }else{
                    //     var payScriptUrl='https://testapi.pinquduo.cn/api_3_0_1/Purchase/getBuy'+location.search.replace('&num='+buy_count,'&num='+self_.buy_count)+'&address_id='+address_id+'&openid='+openid+'&code='+self_.pay_oauth+'&ajax_get=1&version=2.0.0';
                    // };
                    // //使用优惠券
                    ...
                    $.ajax({
                        type:'GET',
                        url: 'https://testapi.pinquduo.cn/api_3_0_1/goods/getCompleteBuy?wxv=2&ajax_get=1&order_id='+order_id+'&openid='+openid+'&code='+self_.pay_oauth,//获取数据
                        // dataType:'jsonp',
                        // jsonp: 'jsoncallback',
                        async:true,
                        success: function(data) {
