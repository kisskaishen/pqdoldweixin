...
//https://testapi.pinquduo.cn/api_3_0_1/api/index/get_seconds_kill_time&ajax_get=1
...
new Vue({
	...
	methods: {
		...
		get_times: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://testapi.pinquduo.cn/api_3_0_1/index/get_seconds_kill_time&ajax_get=1&version=2.0.0',//获取时间轴数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:true,
				success:function(data){
		...
		get_data: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://testapi.pinquduo.cn/api_3_0_1/index/get_Seconds_Kill?ajax_get=1&version=2.0.0&starttime='+self_.starttime+'&endtime='+self_.endtime+'&page='+self_.page+'&pagesize='+self_.pagesize,//获取商品列表数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:true,
				success:function(data){
