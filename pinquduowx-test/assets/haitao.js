				...
				page_vm = new Vue({
					...
					mounted: function(){
						...
						self_.$nextTick(function(){
							//海淘品牌滑动
						    var brand_scroll = new Swiper('#brand-scroll', {
						        slidesPerView: 'auto',
							...
							//海淘分类滑动
							var  category_scroll = new Swiper('#ht-category-scroll', {
						        slidesPerView: 'auto',
						        paginationClickable: true,
						        spaceBetween:0,
						        observer:true,//修改swiper自己或子元素时，自动初始化swiper
						...
						pullup_load({
							...
							callback: function(){
								...
								page +=1;
								update_data("https://testapi.pinquduo.cn/api_3_0_1/index/getHaiTao&version=2.0.0&ajax_get=1"+'&page='+page+'&pagesize='+self_.pagesize);
							}
						});
						set_active();
					}
...
update_data("https://testapi.pinquduo.cn/api_3_0_1/index/getHaiTao&version=2.0.0&ajax_get=1"+'&page='+1+'&pagesize='+6);
