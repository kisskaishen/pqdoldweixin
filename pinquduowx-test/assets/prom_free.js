...
// console.log(MD5('https://testapi.pinquduo.cn/api_3_0_1/index/get_Free_Order?appversion=1.3.6&latitude=0&longitude=0&os=10.3.1&terminal=i&user_id=10928&version=2.0.0'));
...
new Vue({
	...
	mounted: function(){
		var self_ = this;
		self_.url='https://testapi.pinquduo.cn/api_3_0_1/index/get_Free_Order?free_num='+self_.free_num+'&page=1&pagesize=8&version=2.0.0';
        ...
        // if(self_.items.length<self_.total){
            pullup_load({
                ...
                callback: function(){
                    self_.page +=1;
                    self_.url='https://testapi.pinquduo.cn/api_3_0_1/index/get_Free_Order?free_num='+self_.free_num+'&page='+self_.page+'&pagesize=8&version=2.0.0&ajax_get=1';
                    if(!self_.isloadmore){
	...
	methods: {
		get_regiment: function(url){
			var self_ = this;
            self_.url='https://testapi.pinquduo.cn/api_3_0_1/index/get_Free_Order?free_num='+self_.free_num+'&page=1&pagesize=8&version=2.0.0&ajax_get=1';
            // self_.url=MD5(self_.url);
