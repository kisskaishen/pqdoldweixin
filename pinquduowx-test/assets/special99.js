					...
					mounted: function(){
						...
						pullup_load({
							...
							callback: function(){
								...
								page +=1;
								update_data("https://testapi.pinquduo.cn/api_3_0_1/index/getJiuJiu?version=2.0.0&page="+page+'&pagesize='+self_.pagesize+"&ajax_get=1");
							}
						});
						set_active();
					}
...
update_data("https://testapi.pinquduo.cn/api_3_0_1/index/getJiuJiu?version=2.0.0&page="+1+'&pagesize='+6+"&ajax_get=1");
