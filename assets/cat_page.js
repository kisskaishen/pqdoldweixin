...
$.ajax({
    ...
    success: function(data) {
		...
		var share_config = {
		    ...
		    shareUrl: share_url,
		    link: share_url, // 分享链接
		    imgUrl: 'https://z.pinquduo.cn/Template/pc/pinquduo/Static/images/pqdlogo.jpg', // 分享图标
...
setShareInfo({
    ...
    pic: 'https://z.pinquduo.cn/Template/pc/pinquduo/Static/images/pqdlogo.jpg',
    url: share_url
});
...
$.ajax({
	type:'POST',
	url:'https://z.pinquduo.cn/api_3_0_1/index/getexplore&ajax_get=1',//获取数据
	dataType:'jsonp',
	jsonp: 'jsoncallback',
	async:true,
	success:function(data){
		...
		$.ajax({
			type:'POST',
			url:'https://z.pinquduo.cn/api_3_0_1/goods/getMore?version=2.0.0&'+'id='+cat_id+'&type='+cat_type+'&page='+1+'&pagesize='+6+'&ajax_get=1',//获取数据
			dataType:'jsonp',
			jsonp: 'jsoncallback',
			async:true,
			success:function(data){
						...
						self_.$nextTick(function(){
							...
							tab_items.each(function(i){
								...
								this_.bind('click',function(){
									...
									$.ajax({
										type:'POST',
										url:'https://z.pinquduo.cn/api_3_0_1/goods/getMore?version=2.0.0&'+'id='+self_.cat_id+'&type='+cat_type+'&page='+self_.page+'&pagesize='+6+'&ajax_get=1',//获取数据
										dataType:'jsonp',
										jsonp: 'jsoncallback',
										async:true,
										success:function(data){
						...
						up_load: function(){
							...
							pullup_load({
								...
								callback: function(){
									...
									$.ajax({
										type:'POST',
										url: 'https://z.pinquduo.cn/api_3_0_1/goods/getMore?version=2.0.0&'+'id='+(self_.cat_id||cat_id)+'&type='+cat_type+'&page='+self_.page+'&pagesize='+6+'&ajax_get=1',//获取数据
										dataType:'jsonp',
										jsonp: 'jsoncallback',
										async:true,
										success:function(data){
