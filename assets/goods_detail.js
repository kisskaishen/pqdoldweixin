...
$.ajax({
	type:'post',
	url:'https://z.pinquduo.cn/api_3_0_1/Goods/getDetaile?goods_id='+goods_id+'&user_id='+user_id+'&ajax_get=1&version=2.0.0',//获取数据
	dataType:'jsonp',
	jsonp: 'jsoncallback',
	async:true,
        ...
        new Vue({
            ...
            methods: {
                ...
                expand:function (){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://z.pinquduo.cn/api_3_0_1/goods/getDetaile_expand?goods_id=' + goods_id + '&user_id=' + user_id + '&ajax_get=1&version=2.0.0',//获取数据
                        dataType: 'jsonp',
                        jsonp: 'jsoncallback',
                        async: true,
                        success: function (data) {
                ...
                getGroup:function (){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://z.pinquduo.cn/api_3_0_1/goods/getAvailableGroup?goods_id=' + goods_id + '&user_id=' + user_id + '&ajax_get=1&version=2.0.0',//获取数据
                        dataType: 'jsonp',
                        jsonp: 'jsoncallback',
                        async: true,
                        success: function (data) {
                ...
                collect: function(){
                    ...
                    $.ajax({
                        type:'POST',
                        url:'https://z.pinquduo.cn/api_3_0_1/goods/collectGoods'+'?user_id='+user_id+'&goods_id='+goods_id+'&type='+collect_type+'&ajax_get=1',//获取数据
                        dataType:'jsonp',
                        jsonp: 'jsoncallback',
                        async:true,
                        success: function(data){
