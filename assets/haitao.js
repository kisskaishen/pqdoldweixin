					...
					mounted: function(){
						...
						pullup_load({
							...
							callback: function(){
								...
								page +=1;
								update_data("https://z.pinquduo.cn/api_3_0_1/index/getHaiTao&version=2.0.0&ajax_get=1"+'&page='+page+'&pagesize='+self_.pagesize);
							}
						});
						set_active();
					}
...
update_data("https://z.pinquduo.cn/api_3_0_1/index/getHaiTao&version=2.0.0&ajax_get=1"+'&page='+1+'&pagesize='+6);
