...
new Vue({
	...
	methods: {
		...
		get_coupon: function(index){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/user/getCouponList'+'?version=2.0.0&user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&state='+index+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		up_load: function(index){
			...
			pullup_load({
				...
				callback: function(){
					...
					$.ajax({
						type:'POST',
						url:'https://z.pinquduo.cn/api_3_0_1/api/user/getCouponList'+'?user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&state='+index+'&ajax_get=1',//获取数据
						dataType:'jsonp',
						jsonp: 'jsoncallback',
						async:true,
						success:function(data){
