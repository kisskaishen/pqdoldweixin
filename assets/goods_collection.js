...
new Vue({
	...
	methods: {
		...
		get_collect_goods: function(){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/user/getUserCollection'+'?version=2.0.0&user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		cancel_collect: function(goods_id){
			...
			self_.uncollect_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/goods/collectGoods'+'?version=2.0.0&user_id='+user_id+'&type=1'+'&goods_id='+goods_id+'&ajax_get=1',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:false,
					success:function(data){
