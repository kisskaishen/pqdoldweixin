...
$.ajax({
	type:'POST',
	url:'https://z.pinquduo.cn/api_3_0_1/store/getStoreList?'+ qs,//获取数据
	dataType:'jsonp',
	jsonp: 'jsoncallback',
	async:true,
	success:function(data){
        ...
        new Vue({
			...
			methods: {
				...
				draw_coupon: function(e){
					...
					//console.log('https://z.pinquduo.cn/api_3_0_1/api/user/getReceiveCoupon?'+'user_id='+user_id+'&coupon_id='+coupon_id+'&ajax_get=1')
					var qs = sign.sign({
						user_id: user_id,
						coupon_id: coupon_id,
						ajax_get: 1,
					...
					$.ajax({
						type:'POST',
						url:'https://z.pinquduo.cn/api_3_0_1/user/getReceiveCoupon?' + qs,//获取数据
						dataType:'jsonp',
						jsonp: 'jsoncallback',
						async:true,
						success:function(data){
