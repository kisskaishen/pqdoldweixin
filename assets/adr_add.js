...
new Vue({
	...
	methods: {
		...
		get_Address: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/goods/getUserAddressList/user_id/5838?user_id='+user_id+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:true,
				success:function(data){
		...
		del_address: function(address_id){
			...
			self_.adr_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/goods/delAddress'+'?user_id='+user_id+'&address_id='+address_id+'&ajax_get=1',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:true,
					success:function(data){
