...
$.ajax({
    type:'POST',
    url:'https://z.pinquduo.cn/api_3_0_1/user/get_Detaile_for_Prom?prom_id=' +prom_id+'&user_id='+user_id+'&ajax_get=1&version=2.0.0',//获取数据
    dataType:'jsonp',
    jsonp: 'jsoncallback',
    async:false,
                ...
                up_load: function(){
                    ...
                    pullup_load({
                        ...
                        callback: function(){
                            ...
                            $.ajax({
                                type:'POST',
                                url:'https://z.pinquduo.cn/api_3_0_1/user/get_Detaile_for_Prom?' + qs,//获取数据
                                dataType:'jsonp',
                                jsonp: 'jsoncallback',
                                async:true,
                                success:function(data){
