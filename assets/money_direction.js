...
if(free){
    url='getUserMoney';
    // self_.url='https://z.pinquduo.cn/api_3_0_1/user/getUserMoney'+'?version=2.0.0&order_id='+order_id+'&ajax_get=1';
    //     console.log(1);
}else {
    // self_.url='https://z.pinquduo.cn/api_3_0_1/user/getWhere_Is_The_Money'+'?version=2.0.0&order_id='+order_id+'&ajax_get=1';
...
new Vue({
	...
	methods: {
		...
		get_courier: function(){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/user/'+url+'?version=2.0.0&order_id='+order_id+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
