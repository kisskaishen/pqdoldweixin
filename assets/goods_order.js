...
oauth_login("page_name=goods_order");
...
new Vue({
	...
	methods: {
		...
		get_order: function(index){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/user/getOrderList'+'?user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&type='+index+'&ajax_get=1&version=2.0.0',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		up_load: function(index){
			...
			pullup_load({
				...
				callback: function(){
					...
					$.ajax({
						type:'POST',
						url:'https://z.pinquduo.cn/api_3_0_1/user/getOrderList'+'?user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&type='+index+'&ajax_get=1',//获取数据
						dataType:'jsonp',
						jsonp: 'jsoncallback',
						async:true,
						success:function(data){
		...
		// 	location.href = 'topay.html?goods_id='+goodsInfo.goods_id+'&user_id='+user_id+'&store_id='+goodsInfo.store_id+'&order_id='+goodsInfo.order_id+'&num='+goodsInfo.num+'&is_prom='+is_prom+'&type='+type;
         //    // $.ajax({
         //     //    type:'POST',
         //     //    url:'https://z.pinquduo.cn/api_3_0_1/goods/getCompleteBuy'+'?user_id='+user_id+'&order_id='+goodsInfo.order_id+'&ajax_get=1&version=2.0.0',//获取数据
         //     //    dataType:'jsonp',
         //     //    jsonp: 'jsoncallback',
         //     //    async:true,
         //     //    success:function(data){
		...
		cancel_order: function(goodsInfo){
			...
			self_.order_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/user/cancelOrder'+'?user_id='+user_id+'&order_id='+goodsInfo.order_id+'&ajax_get=1&version=2.0.0',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:true,
					success:function(data){
		...
		//延长收货
		delay_receiving: function(order_id){
			var self_ = this;
			self_.dialog_hint = '是否延长收货时间？每笔订单只能延迟一次哦~';
			self_.order_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/api/user/getIncreaseGoodsTime'+'?user_id='+user_id+'&order_id='+order_id+'&ajax_get=1',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:false,
					success:function(data){
		...
		//确认收货
		confirm_receiving: function(order_id){
			var self_ = this;
