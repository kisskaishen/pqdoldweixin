...
new Vue({
	...
	methods: {
		...
		get_order: function(index){
		    ...
		    $.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/user/getUserFreeOrder'+'?version=2.0.0&user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&type='+index+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		cancel_order: function(goodsInfo){
			...
			self_.order_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/api/user/cancelOrder'+'?user_id='+user_id+'&order_id='+goodsInfo.order_id+'&ajax_get=1',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:true,
					success:function(data){
		...
		confirm_receiving: function(order_id){
			...
			self_.order_dialog(function(){
				$.ajax({
					type:'POST',
					url:'https://z.pinquduo.cn/api_3_0_1/api/user/orderConfirm'+'?user_id='+user_id+'&order_id='+order_id+'&ajax_get=1',//获取数据
					dataType:'jsonp',
					jsonp: 'jsoncallback',
					async:false,
					success:function(data){
		...
		up_load: function(index){
			...
			pullup_load({
				...
				callback: function(){
					...
					$.ajax({
						type:'POST',
						url:'https://z.pinquduo.cn/api_3_0_1/api/user/getUserFreeOrder'+'?user_id='+user_id+'&page='+self_.page+'&pagesize='+self_.pagesize+'&type='+index+'&ajax_get=1',//获取数据
						dataType:'jsonp',
						jsonp: 'jsoncallback',
						async:true,
						success:function(data){
