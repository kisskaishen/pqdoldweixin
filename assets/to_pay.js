...
new Vue({
	...
	methods: {
		...
		get_data: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/goods/getGenerateOrder'+location.search+'&ajax_get=1',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		refresh_coupon:function(){
			...
			$.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/goods/getGenerateOrder'+location.search.replace('&num='+buy_count,'&num='+self_.buy_count)+'&ajax_get=1&version=2.0.0',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		get_address: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/goods/getUserAddressList/user_id/5838?user_id='+user_id+'&ajax_get=1&version=2.0.0',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		get_coupon: function(){
			...
			$.ajax({
				type:'POST',
				url:'https://z.pinquduo.cn/api_3_0_1/goods/getCoupon?user_id='+user_id+'&store_id='+store_id+'&goods_id='+goods_id+'&num='+self_.buy_count+'&type='+type+'&ajax_get=1&version=2.0.0',//获取数据
				dataType:'jsonp',
				jsonp: 'jsoncallback',
				async:false,
				success:function(data){
		...
		pay: function(){
			...
			if(self_.data.goods.prom==0&&prom_type==1){
				//免单拼开团
				var payScriptUrl='https://z.pinquduo.cn/api_3_0_1/Purchase/getBuy'+location.search.replace('&num='+buy_count,'&num='+self_.buy_count)+'&address_id='+address_id+'&prom='+self_.prom_count+'&free='+self_.free_count+'&openid='+openid+'&code='+self_.pay_oauth+'&ajax_get=1&version=2.0.0&wxv=2';
			}else{
				var payScriptUrl='https://z.pinquduo.cn/api_3_0_1/Purchase/getBuy'+location.search.replace('&num='+buy_count,'&num='+self_.buy_count)+'&address_id='+address_id+'&openid='+openid+'&code='+self_.pay_oauth+'&ajax_get=1&version=2.0.0&wxv=2';
			};
			//使用优惠券
