...
new Vue({
    ...
    methods: {
        ...
        get_header_data: function() {
            ...
            $.ajax({
                type: 'GET',
                url: 'https://z.pinquduo.cn/api_3_0_1/api/index/getexplore?ajax_get=1&version=2.0.0', //获取首页数据
                dataType: 'jsonp',
                jsonp: 'jsoncallback',
                async: true,
                success: function(data) {
        ...
        //     $.ajax({
        //         type: 'GET',
        //         url: 'https://z.pinquduo.cn/api_3_0_1/index/home?version=2.0.0' + '&pagesize=' + self_.pagesize + '&page=' + page + '&ajax_get=1&version=2.3', //获取首页数据
        //         dataType: 'jsonp',
        //         jsonp: 'jsoncallback',
        //         async: true,
        //         success: function(data) {
        ...
        //     $.ajax({
        //         type: 'GET',
        //         url: 'https://z.pinquduo.cn/api_3_0_1/api/index/getexplore&ajax_get=1', //获取数据
        //         dataType: 'jsonp',
        //         jsonp: 'jsoncallback',
        //         async: true,
        //         success: function(data) {
        ...
        //         $.ajax({
        //             type: 'GET',
        //             url: 'https://z.pinquduo.cn/api_3_0_1/api/user/getPromDetail?invitation_num=' + prom_code + '&user_id=' + cookie.get('user_id') + '&ajax_get=1',
        //             dataType: 'jsonp',
        //             jsonp: 'jsoncallback',
        //             async: true,
        //             success: function(data) {
        ...
        //     } else { //其他分类页
        //         self_.get_cats_goods("https://z.pinquduo.cn/api_3_0_1/goods/getMore?version=2.0.0&page=" + page + "&ajax_get=1&id=" + id + "&pagesize="+ self_.pagesize,index-1);
        //         self_.pullup_load = pullup_load({
        //             wrap: $('body'),
